...
public class DataDosen08 {
    ...
    public void dataSemuaDosen(Dosen08[] arrOfDosen) {
        for (int i = 0; i < arrOfDosen.length; i++) {
            arrOfDosen[i].cetakInfo();
        }
    }

    void jumlahDosenPerJenisKelamin(Dosen08[] arrOfDosen) {
        int lk = 0, pr = 0;
    ...
    void rerataUsiaDosenPerJenisKelamin(Dosen08[] arrOfDosen) {
    ...
    void infoDosenPalingMuda(Dosen08[] arrOfDosen) {
        Dosen08 termuda = arrOfDosen[0];
        for (int i = 0; i < arrOfDosen.length; i++) {
    ...
    void infoDosenPalingTua(Dosen08[] arrOfDosen) {
        Dosen08 tertua = arrOfDosen[0];
        for (int i = 0; i < arrOfDosen.length; i++) {
